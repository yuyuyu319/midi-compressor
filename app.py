...
<head>
    ...
    <title>MIDI Compressor | ピアノロール・プレビュー付ベロシティ圧縮ツール</title>
...
<body>
    <div class="card">
        ...
        <form action="/process" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="threshold" id="threshold" value="80" min="1" max="127">
            </div>
            <div class="form-group">
                <label>レシオ (比率 1.0 - 10.0)</label>
                <input type="number" name="ratio" id="ratio" value="2.0" step="0.1" min="1.0" max="10.0">
            </div>

            <div id="preview-container">
                <div class="legend">
                    <div class="legend-item"><span style="background: #475569;"></span>元の値</div>
                    <div class="legend-item"><span style="background: var(--accent);"></span>圧縮後</div>
                </div>
    ...
    <div class="content-section">
        ...
        <p>オーディオ用のコンプレッサーと同様に、スレッショルドを超えたベロシティをレシオに基づいて圧縮します。MIDIリミッターが上限で強制的に切るのに対し、コンプレッサーは超過分を「比率」で減衰させるため、演奏のニュアンスを保ったままピークを自然に抑えることができます。</p>
    </div>
    ...
    <script>
        ...
        function draw() {
            ...
            notes.forEach((n, i) => {
                ...
                let newV = n.vel;
                if (newV > threshold) {
                    newV = threshold + (newV - threshold) / ratio;
                }
